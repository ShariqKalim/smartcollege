  ...
  return (
    <>
      <div className="w-10/12 mx-auto flex flex-wrap justify-between">
        <NavLink to="/sem_1_cse" className=" no-underline">
        ...
        <NavLink to="/sem_2_cse" className=" no-underline">
          <div className="border-4 shadow-lg p-10 w-72 border-blue-200  mt-20 transform hover:scale-110">
        ...
        <NavLink to="/sem_4_cse" className=" no-underline">
          <div className="border-4 shadow-lg p-10 w-72 border-blue-200 mt-20 transform hover:scale-110">
        ...
        <NavLink to="/sem_5_cse" className=" no-underline">
        ...
        <NavLink to="/sem_6_cse" className=" no-underline">
          <div className="border-4 shadow-lg p-10 w-72 border-blue-200 mt-10 transform hover:scale-110">
        ...
        <NavLink to="/sem_7_cse" className=" no-underline">
          <div className="border-4 shadow-lg p-10 w-72 border-blue-200 mt-10 transform hover:scale-110">
        ...
        <NavLink to="/sem_8_cse" className=" no-underline">
          <div className="border-4 shadow-lg p-10 w-72 border-blue-200 mt-10 transform hover:scale-110">
